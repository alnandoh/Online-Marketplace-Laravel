...
@section('content')
    ...
    <div class="page-content page-cart">
        ...
        <section class="store-cart">
            <div class="container">
                <div class="row" data-aos="fade-up" data-aos-delay="100ms">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    ...
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="btn btn-remove-cart">Remove</button></form>
                                </td>
                            </tr>
                ...
                <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-8 col-md-3">
                            <button
                            type="submit"
                            class="btn btn-success mt-3 px-4 btn-block"
                            >Checkout Now</button
                            >
                        </div>
                    </div>
